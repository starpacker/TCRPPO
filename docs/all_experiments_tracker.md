...
| 8 | test1_two_phase | 📋 PLANNED | 2M | TBD | TBD | v1_ergo_only → raw_decoy | Phase1: 1M pure ERGO, Phase2: 1M +decoy | 0 | **NEW** |
| 9 | test2_min6_raw | 📋 PLANNED | 2M | TBD | TBD | raw_decoy | min_steps=6, raw reward, d=0.05 | 1 | **NEW** |
| 10 | test3_stepwise | 📋 PLANNED | 2M | TBD | TBD | v1_ergo_stepwise | Raw ERGO per-step (absolute score) | 2 | **NEW** |
| 11 | test4_raw_multi | 📋 PLANNED | 2M | TBD | TBD | raw_multi_penalty | raw - 0.05d - 0.02n - 0.01v | 3 | **NEW** Option A |
| 12 | test5_threshold | 📋 PLANNED | 2M | TBD | TBD | threshold_penalty | Conditional penalties at aff>0.5 | 4 | **NEW** Option C |
