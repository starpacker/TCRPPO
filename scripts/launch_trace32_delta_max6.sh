...
# Trace32: trace11-style target delta with a 6-edit horizon.
# Usage:
#   scripts/launch_trace32_delta_max6.sh start  trace32_delta_max6 6
#   scripts/launch_trace32_delta_max6.sh status trace32_delta_max6 6
#   scripts/launch_trace32_delta_max6.sh stop   trace32_delta_max6 6

ROOT="/share/liuyutian/tcrppo_v2"
ACTION="${1:-start}"
TRACE_TAG="${2:-trace32_delta_max6}"
GPU_ID="${3:-6}"
