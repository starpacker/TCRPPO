...
# Trace24: trace11-style target delta, but with substitution-only action space.
# Usage:
#   scripts/launch_trace24_delta_subonly.sh start  trace24_delta_subonly 0
#   scripts/launch_trace24_delta_subonly.sh status trace24_delta_subonly 0
#   scripts/launch_trace24_delta_subonly.sh stop   trace24_delta_subonly 0

ROOT="/share/liuyutian/tcrppo_v2"
ACTION="${1:-start}"
TRACE_TAG="${2:-trace24_delta_subonly}"
GPU_ID="${3:-0}"
